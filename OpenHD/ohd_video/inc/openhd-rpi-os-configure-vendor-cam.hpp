...
if (cam_config_filename.find("imx477m") != std::string::npos) {
    ...
    OHDUtil::run_command("mv /usr/share/libcamera/ipa/raspberrypi/imx477.json /usr/share/libcamera/ipa/raspberrypi/imx477_old.json && cp /usr/share/libcamera/ipa/raspberrypi/imx477m.json /usr/share/libcamera/ipa/raspberrypi/imx477.json", NULL);
    ...
    openhd::log::get_default()->warn("Custom Tuning file found, now it'll be enabled");
    OHDUtil::run_command("cp /usr/share/libcamera/ipa/raspberrypi/imx477_old.json /usr/share/libcamera/ipa/raspberrypi/imx477.json",NULL);
    openhd::log::get_default()->warn("Custom Tuning file written");
    }
    else {
