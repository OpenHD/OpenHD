...
void openhd::set_infiray_custom_control_zoom_absolute_async(int value,int v4l2_device_number) {
  ...
  const auto command =
      fmt::format("v4l2-ctl -d /dev/video{} -c zoom_absolute={}",v4l2_device_number, value);
