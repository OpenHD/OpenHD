...
AirCameraGenericSettings AirCameraGenericSettingsHolder::create_default()
  ...
  } else if (OHDPlatform::instance().platform_type == X_PLATFORM_TYPE_ROCKCHIP_RV1103 || OHDPlatform::instance().platform_type == X_PLATFORM_TYPE_ROCKCHIP_RV1106) {
    ret.primary_camera_type = X_CAM_TYPE_ROCKCHIP_RV;
  }
