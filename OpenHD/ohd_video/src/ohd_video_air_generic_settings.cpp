...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(
    ...
    secondary_camera_type, enable_audio, ip_camera_bitrate_mbits, audio_source, audio_volume);
...
AirCameraGenericSettings AirCameraGenericSettingsHolder::create_default()
  ...
  if (OHDPlatform::instance().is_rpi()) {
    ...
    ret.primary_camera_type = X_CAM_TYPE_ROCKCHIP_RV1126_CSI;
             ...
             X_PLATFORM_TYPE_LUCKFOX_AURA) {
    ret.primary_camera_type = X_CAM_TYPE_LUCKFOX_AURA_IMX415;
  }
