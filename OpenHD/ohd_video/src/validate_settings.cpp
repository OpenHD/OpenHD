...
std::optional<openhd::TmpVideoFormat> openhd::parse_video_format(const std::string &videoFormat) {
...
std::string openhd::video_format_from_int_values(int width, int height, int framerate) {
    std::stringstream ss;
