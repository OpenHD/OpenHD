...
// 3) You can now pipe test data into the "air instance" via UDP (e.g. into the main stream video port)
// and listen with nc if any data arrives at the ground instance.
