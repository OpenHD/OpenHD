...
// Returns true if the card is supported (we only support a few, but keep
// working with other cards)
...
// Return true if any of the given wifi cards supports monitor mode (but perhaps
// / quite likely no injection and definitely not the full openhd feature set)
