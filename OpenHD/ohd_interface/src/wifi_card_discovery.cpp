...
void DWifiCards::main_discover_an_process_wifi_cards(const openhd::Config &config, const OHDProfile &m_profile,
                                                     const OHDPlatform &m_platform, const bool continue_without_wb_card,
