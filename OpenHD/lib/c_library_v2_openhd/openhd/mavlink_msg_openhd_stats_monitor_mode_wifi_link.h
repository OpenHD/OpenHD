...
typedef struct __mavlink_openhd_stats_monitor_mode_wifi_link_t {
 ...
 uint64_t curr_rx_packet_loss; /*<  curr_rx_packet_loss*/
...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_LEN 56
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_MIN_LEN 56
#define MAVLINK_MSG_ID_1212_LEN 56
#define MAVLINK_MSG_ID_1212_MIN_LEN 56

#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_CRC 7
#define MAVLINK_MSG_ID_1212_CRC 7
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_LINK { \
    ...
    {  { "curr_tx_pps", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_tx_pps) }, \
         ...
         { "curr_rx_packet_loss", NULL, MAVLINK_TYPE_UINT64_T, 0, 32, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_rx_packet_loss) }, \
         { "unused0", NULL, MAVLINK_TYPE_INT32_T, 0, 40, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused0) }, \
         { "unused1", NULL, MAVLINK_TYPE_INT32_T, 0, 44, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused1) }, \
         { "unused2", NULL, MAVLINK_TYPE_INT32_T, 0, 48, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused2) }, \
         { "unused3", NULL, MAVLINK_TYPE_INT32_T, 0, 52, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_LINK { \
 ...
 * @param curr_rx_packet_loss  curr_rx_packet_loss
...
static inline uint16_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t curr_tx_pps, uint64_t curr_rx_pps, uint64_t curr_tx_bps, uint64_t curr_rx_bps, uint64_t curr_rx_packet_loss, int32_t unused0, int32_t unused1, int32_t unused2, int32_t unused3)
{
    ...
    _mav_put_uint64_t(buf, 32, curr_rx_packet_loss);
    _mav_put_int32_t(buf, 40, unused0);
    _mav_put_int32_t(buf, 44, unused1);
    _mav_put_int32_t(buf, 48, unused2);
    _mav_put_int32_t(buf, 52, unused3);
    ...
    packet.curr_rx_packet_loss = curr_rx_packet_loss;
...
{
    return mavlink_msg_openhd_stats_monitor_mode_wifi_link_pack(system_id, component_id, msg, openhd_stats_monitor_mode_wifi_link->curr_tx_pps, openhd_stats_monitor_mode_wifi_link->curr_rx_pps, openhd_stats_monitor_mode_wifi_link->curr_tx_bps, openhd_stats_monitor_mode_wifi_link->curr_rx_bps, openhd_stats_monitor_mode_wifi_link->curr_rx_packet_loss, openhd_stats_monitor_mode_wifi_link->unused0, openhd_stats_monitor_mode_wifi_link->unused1, openhd_stats_monitor_mode_wifi_link->unused2, openhd_stats_monitor_mode_wifi_link->unused3);
}
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_link_send(mavlink_channel_t chan, uint64_t curr_tx_pps, uint64_t curr_rx_pps, uint64_t curr_tx_bps, uint64_t curr_rx_bps, uint64_t curr_rx_packet_loss, int32_t unused0, int32_t unused1, int32_t unused2, int32_t unused3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_LEN];
    _mav_put_uint64_t(buf, 0, curr_tx_pps);
 ...
 */
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_link_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t curr_tx_pps, uint64_t curr_rx_pps, uint64_t curr_tx_bps, uint64_t curr_rx_bps, uint64_t curr_rx_packet_loss, int32_t unused0, int32_t unused1, int32_t unused2, int32_t unused3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field curr_rx_packet_loss from openhd_stats_monitor_mode_wifi_link message
 *
 * @return  curr_rx_packet_loss
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_curr_rx_packet_loss(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_link_decode(const mavlink_message_t* msg, mavlink_openhd_stats_monitor_mode_wifi_link_t* openhd_stats_monitor_mode_wifi_link)
{
    ...
    openhd_stats_monitor_mode_wifi_link->curr_rx_packet_loss = mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_curr_rx_packet_loss(msg);
