...
int main(int argc, char *argv[]) {
  ...
  std::cout << "SerialEndpointTest::start with ["<<serial_port_filename<<" : "<<baud_rate<<"]\n";

  SerialEndpoint serialEndpoint("TestSerialPort", {serial_port_filename,baud_rate}, true); //115200
