...
std::optional<GPIOControlSettings>
GPIOControlSettingsHolder::impl_deserialize(const std::string &file_as_string) const {
    return openhd_json_parse<GPIOControlSettings>(file_as_string);
}

std::string GPIOControlSettingsHolder::imp_serialize(const GPIOControlSettings &data) const {
