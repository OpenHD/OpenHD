...
void MavlinkMessageHandler::register_one(uint16_t msg_id,
...
void MavlinkMessageHandler::unregister_one(uint16_t msg_id,
                                           const void* cookie) {
  std::lock_guard<std::mutex> lock(_mutex);
...
void MavlinkMessageHandler::update_component_id(uint16_t msg_id,
