...
openhd::telemetry::ground::SettingsHolder::impl_deserialize(const std::string &file_as_string) const {
    return openhd_json_parse<Settings>(file_as_string);
}

std::string
openhd::telemetry::ground::SettingsHolder::imp_serialize(const openhd::telemetry::ground::Settings &data) const {
