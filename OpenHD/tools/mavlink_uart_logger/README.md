...
The status line at the top reports the outcome of the most recent command and whether logging is enabled. When `--raw` is active,
an additional panel displays the latest UART bytes in hexadecimal order whenever the tool is receiving.
