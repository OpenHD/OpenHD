...
/**
 * Similar to openhd_led, openhd_buttons abstracts away hw-differences regarding buttons.
 * (Or stuff similar to buttons)
 * Some functionalities might not be supported on some hardware types, or a button might
 * actually be a gpio jumper for now.
 */
class ButtonManager{
 public:
