...
void
openhd::ArmingStateHelper::register_listener(const std::string &tag, openhd::ArmingStateHelper::STATE_CHANGED_CB cb) {
...
void openhd::FCRcChannelsHelper::update_rc_channels(const std::array<int, 18> &rc_channels) {
