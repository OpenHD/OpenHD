...
void usage(void) {
    printf("Usage: rctxUDP_IN  $ChannelBandSwitcher $ChannelIPCamera $IsBandSwitcherEnabled $IsIPCameraSwitcherEnabled $IsEncrypt $NICS wlan0\n"
           "\n"
           "Example:\n"
...
int main(int argc, char *argv[]) {
    ...
    // UDP RC Encrypted out init end



    // Outgoing BandSwitch socket init
    ...
    // Outgoing BandSwitch socket end
    ...
    // UDP IP or USB camera sender init end



    // RSSI shared memory init
    telemetry_data_t td;
    telemetry_init(&td);
    int k = 0;
