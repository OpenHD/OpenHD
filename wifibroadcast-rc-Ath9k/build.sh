...
g++ -I../wifibroadcast-base rctx.cpp -o rctx `sdl-config --libs` `sdl-config --cflags` -lrt -ljetgpio -lpcap -lboost_system -lboost_regex -lboost_filesystem -lboost_thread -lpthread
