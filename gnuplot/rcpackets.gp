...
set style line 6 lt 1 lc rgb "#FA00DC" lw 2
set style line 7 lt 1 lc rgb "#AF00DC" lw 2

# Name our output file
set output "/media/usb/rssi/rcpackets.png"
...
# Put X and Y labels
set xlabel "seconds"
set ylabel "packets lost per second"
...
plot "/wbc_tmp/rcrssi.csv" u 1:3 w lines ls 1 t "pkts lost/second"
