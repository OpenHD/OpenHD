...
#define MAVLINK_MSG_ID_OPENHD_AIR_LOAD_CRC 1
#define MAVLINK_MSG_ID_1230_CRC 1
...
#define MAVLINK_MESSAGE_INFO_OPENHD_AIR_LOAD { \
    ...
    "OPENHD_AIR_LOAD", \
    4, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_openhd_air_load_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_openhd_air_load_t, target_component) }, \
         { "cpuload", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_openhd_air_load_t, cpuload) }, \
         { "temp", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_openhd_air_load_t, temp) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_AIR_LOAD { \
...
{
    return mavlink_msg_openhd_air_load_pack(system_id, component_id, msg, openhd_air_load->target_system, openhd_air_load->target_component, openhd_air_load->cpuload, openhd_air_load->temp);
}
...
{
    return mavlink_msg_openhd_air_load_pack_chan(system_id, component_id, chan, msg, openhd_air_load->target_system, openhd_air_load->target_component, openhd_air_load->cpuload, openhd_air_load->temp);
}
...
static inline void mavlink_msg_openhd_air_load_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t cpuload, uint8_t temp)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_AIR_LOAD_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_openhd_air_load_send(chan, openhd_air_load->target_system, openhd_air_load->target_component, openhd_air_load->cpuload, openhd_air_load->temp);
#else
 ...
 */
static inline void mavlink_msg_openhd_air_load_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t cpuload, uint8_t temp)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
