...
do
        ...
        /usr/local/share/cameracontrol/IPCamera/svpcom_wifibroadcast/wfb_tx -u 5600 -t 2 -p 23 -B 20 -M $DATARATE_SECONDARY_8812AU -n $VIDEO_BLOCKS_SECONDARY -k $VIDEO_FECS_SECONDARY -K /tmp/tx.key $NICS_LIST
